...
const AssignTo = ({
    ...
    const { admins, adminsLoading, adminsError, setSearchQuery, searchQuery, assignToAdminMutation, assignToAdminLoading, assignToAdminError, assignToAdminSuccess, unAssignAdminMutation, unAssignAdminLoading, unAssignAdminError, unAssignAdminSuccess } = useAdminsContext()
                                    ...
                                    assignedTo?.id && (
                                        <div className="flex flex-col px-1 py-2">
                                            <AssignedAdmin
                                                ...
                                                unassignAdminMutation={unAssignAdminMutation}
                                                unassignAdminLoading={unAssignAdminLoading}
                                                unassignAdminError={unAssignAdminError}
                                                unassignAdminSuccess={unAssignAdminSuccess}
                                            />
                                        </div>
                                    )
                                }
