...
import extractEncounterDetails from '../../dashboard/components/outcome-page/utils/extract-encounter-details';
...
const useApprovedClaims = () => {
    ...
    const getApprovedClaims = async () => {
        ...
        const response = await protectedApi.GET("/claims/approved", { ...params })
        return response
    }
