...
const Table = () => {
    const { setShowClaimDetail, showClaimDetail, tableData, isApprovedClaimsPending: isLoading, sorting, setSorting, isAllClaimsSelected, handleSelectAllClaims, handleUnselectAllClaims } = useApprovedContext();
