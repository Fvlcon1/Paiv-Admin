...
export type ISpecialties = "All" | "OPDC" | "DERM" | "ENT" | "PAED" | "GEN" | "ENTH" | "OPHT" | "ZOOM02" | "ZOOM05"

const useApprovedClaims = () => {
    const [selectedClaims, setSelectedClaims] = useState<string[]>([])
    const [selectedSpecialties, setSelectedSpecialties] = useState<ISpecialties[]>(["All"])
    ...
    const getApprovedClaims = async (endpoint: string) => {
        ...
        const response = await protectedApi.GET(endpoint, { ...params })
        return response
    }
