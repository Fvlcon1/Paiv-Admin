...
import useEditUser, { IUserInfo } from "./hooks/useEditUser"
...
const Form = ({
    ...
    const { formik, isEditPending, regionDropdown, searchRegion, setSearchRegion, districtDropdown, searchDistrict, setSearchDistrict } = useEditUser({ close, user })
