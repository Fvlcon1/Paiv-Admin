...
const ChartCarousel = () => {
    ...
    const charts = [
        ...
        { id: 2, component: <BarChart />, label: "Distribution" },
        { id: 3, component: <RadarChart />, label: "Patterns" },
        { id: 4, component: <HeatMap />, label: "Intensity" },
    ];
...

            {
                !isDashboardDataPending && (
                    <>
                        ...
                        <button
                            onClick={() => navigate(-1)}
                            className="absolute left-0 h-full w-[100px] rounded-l-2xl flex items-center justify-center top-1/2 cursor-pointer -translate-y-1/2 p-2 opacity-0 hover:opacity-100 bg-[#00000023] duration-300"
                        ...
                        <button
                            onClick={() => navigate(1)}
                            className="absolute right-0 h-full w-[100px] rounded-r-2xl flex items-center justify-center top-1/2 cursor-pointer -translate-y-1/2 p-2 opacity-0 hover:opacity-100 bg-[#00000023] duration-300"
